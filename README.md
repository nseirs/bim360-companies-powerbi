...
To run this template, you need  **Client ID**, **Client Secret**, and **BIM 360 Account ID** from steps 1 & 2 in **Setup**[**Setup**](#setup) and you need to setup R as per step 3 in [**Setup**](#setup).
